...
<aside class="app-sidebar toggle-sidebar">
    <ul class="side-menu toggle-menu">
        <li>
            <a class="side-menu__item" href="{{ url('booking') }}">
                <i class="side-menu__icon mdi fs-2 mdi-ticket-percent"></i><span class="side-menu__label">
                    Booking </span>
            </a>
        </li>
        <li>
        ...
        <li>
            <a class="side-menu__item" href="{{ url('slider') }}"><i
                    class="side-menu__icon mdi mdi-file-image"></i><span class="side-menu__label">Banner
                    Slider</span></a>
        </li>
        <li>
